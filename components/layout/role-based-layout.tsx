...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const managerNavItems = [
    ...
    { href: "/dashboard/payments/prorate", icon: DollarSign, label: "Prorate" },
    { href: "/dashboard/payments/dunning", icon: AlertCircle, label: "Late Payment Reminders" },
    { href: "/dashboard/payments/requests", icon: Settings, label: "Schedule Requests" },
